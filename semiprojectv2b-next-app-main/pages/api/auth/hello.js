...
//암호 입력시 해시 함수에 의해 해시코드로 변환된 암호 생성
...
export default async (req,res) =>{
    ...
    try {
       ...
       let isMatch1=comparePasswd('abc123', hashed1);
       let isMatch2=comparePasswd('1', hashed1);
